...
namespace PushWhacker
{
    public class ConfigValues
    {
        public class Layouts
        {
            ...
            public const string WhiteKeys = "White Keys";

            public static string[] Choices = new string[] { InKey, Chromatic, InKeyPlusKS, ChromaticPlusKS, WhiteKeys, Scaler, Strummer, Drums, BigDrums };
        }
        ...
        public class Pressures
        {
            ...
            public const string BoostModulation = "Boost Touch Strip";
        ...
        public class TouchStripModes
        {
            ...
            public const string ModAndExp = "Mod & Expr";
            public const string PitchBend = "PitchBend";

            public static string[] Choices = new string[] { Modulation, Expression, ModAndExp, PitchBend };
        }
        ...
        public bool CcNoRelease { get; set; }
        ...
        public void Load()
        {
            using (RegistryKey regKey = Registry.CurrentUser.OpenSubKey("Software", true).CreateSubKey("PushWhacker"))
            {
                ...
                CcNoRelease = (int)regKey.GetValue("CcNoRelease", 0) != 0;
                ...
                Brightness = (int)regKey.GetValue("Brightness", 64);
        ...
        public void Save()
        {
            using (RegistryKey regKey = Registry.CurrentUser.OpenSubKey("Software", true).CreateSubKey("PushWhacker"))
            {
                ...
                regKey.SetValue("CcNoRelease", CcNoRelease ? 1 : 0);
                ...
                regKey.SetValue("Brightness", Brightness);
                foreach (var cal in (PedalCalibrationId[])Enum.GetValues(typeof(PedalCalibrationId)))
                {
